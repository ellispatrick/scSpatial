FUN <- function(...) {
    ...
    data.frame(
        ...
        SourceUrl=c("https://data.mendeley.com/datasets/cydmwsfztj/2/files/4473bd0c-b617-4c79-8253-8d61fbe4e8e8/Cells.zip?dl=1",
                    ...
                    "https://data.mendeley.com/datasets/cydmwsfztj/2/files/9074990e-1b93-4c79-8c49-1db01a66398b/Donors.zip?dl=1",
                    "https://data.mendeley.com/datasets/cydmwsfztj/2/files/7f855a81-4e9b-4374-bea5-4a1c6e1ed2d7/Islets.zip?dl=1"),
        SourceVersion="1.0",
